...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/foto/slider2.png') ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <div class="container">
                        <img src="<?= base_url('assets/foto/slider2.png') ?>" width="100">
                        <!-- Topbar Navbar -->
                        <ul class="navbar-nav ml-auto">
                            ...
                            <a href="" class="btn btn-primary btn-xs mx-2 my-3"><i class="fas fa-sign-in-alt"></i> Login</a>
                        </ul>
                    </div>
                </nav>
                <!-- End of Topbar -->
